...
class _ResetVerifyPhoneState extends State<ResetVerifyPhone> {
  ...
  void _ApiVerify(){
    ...
    // ApiCalls.verifyForgotPassword(context, txtCode_1.text + txtCode_2.text + txtCode_3.text + txtCode_4.text, phoneNumber);

    Navigator.push(
      context,
      MaterialPageRoute(
          builder: (context) =>  CreateNewPasswordScreen(code: '', phoneNumber: '')
      ),
    );
  }
