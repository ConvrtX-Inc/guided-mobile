...
class WhatIsIncludedInYourAdventureScreen extends StatefulWidget {
  ...
  @override
  _WhatIsIncludedInYourAdventureScreenState createState() => _WhatIsIncludedInYourAdventureScreenState();
}

class _WhatIsIncludedInYourAdventureScreenState extends State<WhatIsIncludedInYourAdventureScreen> {
                  ...
                  child: SingleChildScrollView(
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          HeaderText.headerText("What's included in your Adventure?"),
                          SizedBox(
                            height: 20.h,
                          ),
                        ],
        ...
        child: SizedBox(
          ...
          child: ElevatedButton(
            onPressed: () {
              ...
              Navigator.pushNamed(context, AppRoutes.WILL_TRAVELLERS_NEED_TO_BRING_ANYTHING_ON_YOUR_ADVENTURE);
            },
