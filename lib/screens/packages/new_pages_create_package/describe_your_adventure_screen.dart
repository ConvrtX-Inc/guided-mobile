...
class DescribeYourAdventureScreen extends StatefulWidget {
  ...
  @override
  _DescribeYourAdventureScreenState createState() => _DescribeYourAdventureScreenState();
}

class _DescribeYourAdventureScreenState extends State<DescribeYourAdventureScreen> {
                  ...
                  child: SingleChildScrollView(
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          HeaderText.headerText('Describe your Adventure'),
                          SizedBox(
                            height: 20.h,
                          ),
                        ],
        ...
        child: SizedBox(
          ...
          child: ElevatedButton(
            onPressed: () {
              ...
              Navigator.pushNamed(context, AppRoutes.TELL_TRAVELLERS_AND_US_MORE_ABOUT_YOU);
            },
