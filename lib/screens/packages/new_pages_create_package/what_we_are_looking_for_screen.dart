...
class WhatWeAreLookingForScreen extends StatefulWidget {
  ...
  @override
  _WhatWeAreLookingForScreenState createState() => _WhatWeAreLookingForScreenState();
}
                  ...
                  child: SingleChildScrollView(
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          HeaderText.headerText('What we’re looking for?'),
                          SizedBox(
                            height: 20.h,
                          ),
                        ],
        ...
        child: SizedBox(
          ...
          child: ElevatedButton(
            onPressed: () {
              ...
              Navigator.pushNamed(context, AppRoutes.YOUR_EXPERIENCE);
            },
