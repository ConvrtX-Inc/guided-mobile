...
class _SettingsBecomeAGuide extends State<SettingsBecomeAGuide> {
  ...
  final TextEditingController _whyDoYouThinkController =
      TextEditingController();
  final TextEditingController _describeAdventureYouWantController =
      TextEditingController();
  final TextEditingController _runningLocationsController =
      TextEditingController();
  final TextEditingController _adventuresStandOutController =
      TextEditingController();
  final TextEditingController _whyDoYouWantToWorkController =
      TextEditingController();
  ...
  Future<void> getAllBadges() async {
    ...
    final List<ActivityModel> badgeData =
        await APIServices().getAllBadgesInBecomeAguide();
    setState(() {
  ...
  Future<void> getBecomeAGuideRequest() async {
    ...
    if (res.userId != '' && res.userId != null) {
      ...
      final Map<dynamic, String> values = {
        for (dynamic i = 0; i < split?.length; i++) i: split![i]
      };
      await urlToFile(values[0].toString())
          .then((value) => {setState(() => image1 = value)});
      if (values[1] != null) {
        await urlToFile(values[1]!.replaceAll(' ', '').toString())
            .then((value) => {setState(() => image2 = value)});
      }

      if (values[2] != null) {
        await urlToFile(values[2]!.replaceAll(' ', '').toString())
            .then((value) => {setState(() => image3 = value)});
      }
                  ...
                  if (_isLoading == false)
                    Column(
                      children: <Widget>[
                        ...
                        Text(
                          AppTextConstants.becomeAGuideIntro,
                          textAlign: TextAlign.justify,
                          style: TextStyle(fontSize: 14.sp),
                        ),
                        if (guideRequestStatus == 'pending')
                          Padding(
                        ...
                        if (guideRequestStatus == 'rejected')
                          Padding(
                            padding: const EdgeInsets.fromLTRB(0, 15, 0, 10),
                            child: Container(
                                decoration: const BoxDecoration(
                                ...
                                child: const Padding(
                                    ...
                                    child: Align(
                                      child: Text(
                                        'Your request has been rejected, please update the information below and re-submit your application',
                                        style: TextStyle(
                                          fontWeight: FontWeight.w600,
                                          fontSize: 16,
                                        ),
                        ...
                        textInputWidget('fname', 'First name',
                            _firstNameController, false, _firstNameFocus),
                        textInputWidget('lname', 'Last name',
                            _lastNameController, false, _lastNameFocus),
                        textInputWidget('email', 'Email', _emailController,
                            false, _emailFocus),
                        textInputWidget('number', 'Number', _phoneNoController,
                            false, _phoneNoFocus),
                        textInputWidget('province', 'Province',
                            _provinceController, true, _provinceFocus),
                        textInputWidget(
                            'city', 'City', _cityController, true, _cityFocus),
                                              ...
                                              child: OutlinedButton(
                                                style: ButtonStyle(
                                                    ...
                                                    side: MaterialStateProperty.all(BorderSide(
                                                        color: activities[index]
                                                                    .isChecked ==
                                                                true
                                                            ? AppColors.deepGreen
                                                            : AppColors.grey,
                                                        width: activities[index].isChecked == true ? 1.0 : 0.4.w,
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: Visibility(
                                                          ...
                                                          child: SvgPicture.asset(
                                                              'assets/images/svg/check_green_circle.svg',
                                                              height: 60.h,
                                                              width: 60.w),
                                                        ),
                                                      ),
                                    ...
                                    return Padding(
                                      ...
                                      child: OutlinedButton(
                                        style: ButtonStyle(
                                            ...
                                            side: MaterialStateProperty.all(BorderSide(
                                                color: activities[index].isChecked == true
                                                    ? AppColors.deepGreen
                                                    : AppColors.grey,
                                                width:
                                                    activities[index].isChecked == true
                                                        ? 1.0
                                                        : 0.4.w,
                                                style: BorderStyle.solid))),
                                        child: Row(
                                          children: <Widget>[
                                            Align(
                                              ...
                                              child: Visibility(
                                                ...
                                                //         width: 55.w,
                                                //     ),
                                                child: activities[index].name ==
                                                        'Discovery'
                                                    ? Image.asset(
                                                        'assets/images/badge-Discovery.png',
                                                        height: 55.h,
                                                        width: 55.w,
                                                      )
                                                    : Image.memory(
                        ...
                        textInputWidget('normal', '', _whyDoYouThinkController,
                            true, _whyDoYouThinkFocus),
                        descriptionWidget(
                            'Briefly describe the Adventures you want to host.'),
                        textInputWidget(
                            'message',
                            '',
                            _describeAdventureYouWantController,
                            true,
                            _describeAdventureYouWantFocus),
                        descriptionWidget(
                            'What locations will you be running your Adventures?'),
                        textInputWidget(
                            'normal',
                            '',
                            _runningLocationsController,
                            true,
                            _runningLocationsFocus),
                        descriptionWidget(
                            'What will make your Adventures stand-out?'),
                        textInputWidget(
                            'normal',
                            '',
                            _adventuresStandOutController,
                            true,
                            _adventuresStandOutFocus),
                        descriptionWidget(
                            'Why do you want to work with Guided?'),
                        textInputWidget(
                            'message',
                            '',
                            _whyDoYouWantToWorkController,
                            true,
                            _whyDoYouWantToWorkFocus),
                        ...
                        if (dropdownValue == 'Individual' ||
                            dropdownValue == 'Other')
                          descriptionWidget(
                              "If you selected 'Individual' or 'Other' please let us know who referred you:")
                        else
                          const SizedBox(),
                        if (dropdownValue == 'Individual' ||
                            dropdownValue == 'Other')
                          textInputWidget(
                              'normal', '', _otherController, true, _otherFocus)
                        else
                          const SizedBox(),
                        Align(
                          alignment: Alignment.centerLeft,
                        ...
                        textInputWidget('message', '', _certDescController,
                            true, _certDescFocus),
                        SizedBox(
                          width: double.maxFinite, // set width to maxFinite
                          child: _isGuideRequestLoading == false
                              ? Padding(
                                  padding:
                                      EdgeInsets.fromLTRB(0, 60.h, 0, 25.h),
                                  child: ElevatedButton(
                                    ...
                                    onPressed: () async {
                                      setState(
                                          () => _isGuideRequestLoading = true);
                                      if (_isLoading == true) {
                                        return;
                                      } else {
                                        List<ActivityModel> badges =
                                            <ActivityModel>[];
                                        badges = activities;
                                        final List<ActivityModel>
                                            checkedActivites = badges
                                                .where((ActivityModel i) =>
                                                    i.isChecked == true)
                                                .toList();
                                        ...
                                        if (_firstNameController
                                          ...
                                          for (int l = 0;
                                              l < checkedActivites.length;
                                              l++) {
                                            acts.add(checkedActivites[l].id);
                                          }

                                          final List<File?> localImgs = [
                                            image1,
                                            image2,
                                            image3
                                          ];
                                              ...
                                              final String imgResult =
                                                  await FirebaseServices()
                                                      .uploadImageToFirebase(
                                                          localImgs[i]!,
                                                          'becomeAGuideRequestCertificates');
                                              firebaseImgs.add(imgResult);
                                            }
                                          }

                                          final String? userId = UserSingleton
                                          ...
                                          final Map<String, dynamic> data = {
                                            ...
                                            'image_firebase_url':
                                                firebaseImgs.join(","),
                                            'description':
                                                _certDescController.text
                                          };
                                          dynamic response;
                                          if (requestID == '') {
                                            response = await APIServices()
                                                .request(
                                                    'api/v1/user-guide-request/',
                                                    RequestType.POST,
                                                    needAccessToken: true,
                                                    data: data);
                                            final BecomeAGudeModel res =
                                                BecomeAGudeModel.fromJson(
                                                    response);
                                            if (res.id != '' ||
                                                res.userId != '') {
                                              ...
                                              setState(() {
                                                requestID = res.id!;
                                                guideRequestStatus =
                                                    res.guideRequestStatus!;
                                              });
                                            }
                                          } else {
                                            response = await APIServices().request(
                                                'api/v1/user-guide-request/$requestID',
                                                RequestType.PATCH,
                                                needAccessToken: true,
                                                data: data);
                                            final BecomeAGudeModel res =
                                          ...
                                          const AdvanceSnackBar(
                                            message:
                                                'Please check some fields that are needed to be filled.',
                                            bgColor: Colors.red,
                                            textColor: Colors.white,
                                          ).show(context);
                                        }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<bool>(
        'hasBecomeGuideRequestDat', hasBecomeGuideRequestDat));
    properties.add(StringProperty('requestID', requestID));
    properties.add(DiagnosticsProperty<bool>(
        '_isGuideRequestLoading', _isGuideRequestLoading));
  }
