...
class TransactionCustomerList extends StatefulWidget {
  ...
  _TransactionCustomerListState? _state = null;
  TransactionCustomerList(int f,{Key? key}) : super(key: key) {
  }

  @override
  State<TransactionCustomerList> createState() {
    _state =  _TransactionCustomerListState();
    return _state!;
  }
...
class _TransactionCustomerListState extends State<TransactionCustomerList> {

  List<Transaction> transactions = List.empty(growable: true);

  _TransactionCustomerListState()
  {
  }
  ...
  Widget build(BuildContext context) {
    var lv = ListView.separated(
        ...
        itemBuilder: (BuildContext context, int index) {return TransactionCustomerCard(transactions[index]);}
    );
    return lv;
  }
}
