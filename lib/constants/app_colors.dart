...
class AppColors {
  ...
  /// Returns dusty grey color
  static HexColor dustyGrey = HexColor('#979B9B');

  /// Returns lightning Yellow color
  static HexColor lightningYellow = HexColor('#FFC31A');

  /// Returns medium Green color
  static HexColor mediumGreen = HexColor('#34A853');
