...
class AppTextStyle {
  ...
  static ButtonStyle style = ElevatedButton.styleFrom(
      ...
      textStyle: TextStyle( fontSize: 13, fontWeight: FontWeight.w800, fontFamily: AppTextConstants.fontPoppins),
  ...
  static ButtonStyle tbStyle = TextButton.styleFrom(
    ...
    textStyle: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, fontFamily: AppTextConstants.fontGilroy),
  );
