...
class _SettingsCalendarManagementModalState extends State<SettingsCalendarManagementModal> {
  ...
  Widget build(BuildContext context) {
    ...
    final ButtonStyle tbStyle = TextButton.styleFrom(
      ...
      textStyle: TextStyle( fontSize: 16.0, fontWeight: FontWeight.w600, fontFamily: 'Gilroy'),
    );
    ...
    final ButtonStyle style = ElevatedButton.styleFrom(
        ...
        textStyle: const TextStyle( fontSize: 13.0, fontWeight: FontWeight.w800, fontFamily: 'Poppins'),
        fixedSize: const Size(108.0, 38.0),
    ...
    final ButtonStyle active = ElevatedButton.styleFrom(
        ...
        textStyle: const TextStyle( fontSize: 13, fontWeight: FontWeight.w800, fontFamily: 'Poppins'),
